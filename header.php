          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="imagenes/<?php echo $InfoUsuario['avatar']; ?>" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php echo $InfoUsuario['nombre'];?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="?token=<?php echo md5(0); ?>" class="btn btn-default btn-flat">Perfil</a>
                    </div>
                    <div class="pull-right">
                      <a href="index.php?v=logout" class="btn btn-danger btn-flat">Salir</a>
                    </div>
                  </li>
                </ul>
              </li>
